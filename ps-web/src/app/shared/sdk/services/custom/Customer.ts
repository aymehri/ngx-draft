...
export class CustomerApi extends BaseLoopBackApi {
  ...
  /**
   * Find a related item by id for pronostics.
   *
   * @param {any} id customer id
   *
   * @param {any} fk Foreign key for pronostics
   *
   ...
   * </em>
   */
  public findByIdPronostics(id: any, fk: any): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/customers/:id/pronostics/:fk";
  ...
  /**
   * Delete a related item by id for pronostics.
   *
   * @param {any} id customer id
   *
   * @param {any} fk Foreign key for pronostics
   ...
   */
  public destroyByIdPronostics(id: any, fk: any): Observable<any> {
  ...
  /**
   * Update a related item by id for pronostics.
   *
   * @param {any} id customer id
   *
   * @param {any} fk Foreign key for pronostics
   ...
   * </em>
   */
  public updateByIdPronostics(id: any, fk: any, data: any = {}): Observable<any> {
  ...
  /**
   * Queries pronostics of customer.
   *
   * @param {any} id customer id
   *
   * @param {object} filter 
   ...
   * </em>
   */
  public getPronostics(id: any, filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/customers/:id/pronostics";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Creates a new instance in pronostics of this model.
   *
   * @param {any} id customer id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public createPronostics(id: any, data: any = {}): Observable<any> {
  ...
  /**
   * Deletes all pronostics of this model.
   *
   * @param {any} id customer id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public deletePronostics(id: any): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/customers/:id/pronostics";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countPronostics(id: any, where: any = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/customers/:id/pronostics/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createManyPronostics(id: any, data: any[] = []): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/customers/:id/pronostics";
    let _routeParams: any = {
